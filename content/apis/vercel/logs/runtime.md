...
You can filter and analyze logs for one or more routes defined in your project. The log output is generated for [Vercel Functions](/docs/functions) and [Routing Middleware](/docs/routing-middleware).
...
| **Value**                        | **Description**                                                    |
| -------------------------------- | ------------------------------------------------------------------ |
| **[route](#route)**              | The route name                                                     |
| **[requestPath](#request-path)** | The request path                                                   |

...
title: Static IPs
product: vercel
url: /docs/connectivity/static-ips
type: reference
prerequisites:
  - /docs/connectivity
related:
  ...
  - /docs/connectivity/static-ips/getting-started
...
| **Pricing**           | /month per project, plus [Private Data Transfer](/docs/pricing/regional-pricing) at regional rates | Custom pricing                               |

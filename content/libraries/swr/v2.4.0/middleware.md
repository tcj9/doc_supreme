...
The order of middleware executions will be `a â b â c`, as shown below:
...
You donât need to worry that object might change between renders. Itâs always serialized to the same string, and the fetcher will still receive those object arguments.

<Callout>
  Furthermore, you can use libs like [fast-json-stable-stringify](https://github.com/epoberezkin/fast-json-stable-stringify) instead of `JSON.stringify` â faster and stabler.
</Callout>

...
SWRâs built-in **caching** and **[deduplication](#deduplication)** skips unnecessary network requests, but
...
Itâs very common to reuse SWR hooks in your app. For example, an app that renders the current userâs avatar 5 times:
...
The magic happens â there are only **2 re-renders** now:

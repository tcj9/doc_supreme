...
Use the [`useAuth()`](https://clerk.com/docs/nextjs/reference/hooks/use-auth.md) hook to access the `getToken()` method.
...
Use the global `Clerk.session` object to access the [`getToken()`](https://clerk.com/docs/reference/javascript/session.md#get-token) method.

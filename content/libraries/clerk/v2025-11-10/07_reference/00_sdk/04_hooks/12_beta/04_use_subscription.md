...
| <a id="for" /> `for?`                           | `"user" | "organization"` | Specifies whether to fetch the Subscription for an Organization or a user. Defaults to `'user'`.     |
...
| Property                           | Type                                                                                                                              | Description                                                                                       |
| ---------------------------------- | --------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------- |
| <a id="data" /> `data`             | <code>undefined | null | <a href="https://clerk.com/docs/reference/javascript/types/billing-subscription-resource.md"></a></code> | The subscription object, `undefined` before the first fetch, or `null` if no subscription exists. |
| <a id="error" /> `error`           | `undefined | Error`                                                                                                    | Any error that occurred during the data fetch, or `undefined` if no error occurred.               |
...
| <a id="revalidate" /> `revalidate` | <code>() => void | Promise<void></code>                                                                                           | Function to manually revalidate or refresh the subscription data.                                 |

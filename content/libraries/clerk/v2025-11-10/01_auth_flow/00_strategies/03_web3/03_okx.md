...
Users can connect their OKX Wallet to their account at any time through their user profile page. You can configure your application to use the [Account Portal user profile page](https://clerk.com/docs/guides/account-portal/overview.md#user-profile) or the prebuilt [`<UserProfile />`](https://clerk.com/docs/nextjs/reference/components/user/user-profile.md) component.

...
When you or a user of your application performs certain actions, a webhook can be triggered. You can see the full list of [webhook events](https://clerk.com/docs/guides/development/webhooks/overview.md#supported-webhook-events) for a list of the actions that could result in a Webhook. Depending on the events subscribed to in the [**Webhooks**](https://dashboard.clerk.com/~/webhooks) page in the Clerk Dashboard, a webhook event will be triggered and sent to the specified endpoint in your application.
...
![Using webhooks in development](https://clerk.com/docs/images/integrations/webhooks/webhooks_diagram.png)
...
> Your webhook needs to return a success code like `200` or `201` when it has been successfully handled. This will mark the webhook as successful in the Dashboard and prevent [retries](https://clerk.com/docs/guides/development/webhooks/overview.md#retry).
...
| `404` | The URL for the webhook was not found. Check that your application is running and that [the endpoint is correct in the Clerk Dashboard](https://clerk.com/docs/guides/development/webhooks/debugging.md#check-your-configuration-in-the-clerk-dashboard).                   |
...
To verify the webhook, see the [guide on webhooks](https://clerk.com/docs/guides/development/webhooks/syncing.md) for a detailed code example. You can also visit the [Svix guide on verifying payloads](https://docs.svix.com/receiving/verifying-payloads/how).

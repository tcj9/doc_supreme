...
reference: [https://clerkinc.slack.com/archives/C07U96ZAZ9T/p1759344749115659?thread\_ts=1758659910.343909\&cid=C07U96ZAZ9T](https://clerkinc.slack.com/archives/C07U96ZAZ9T/p1759344749115659?thread_ts=1758659910.343909\&cid=C07U96ZAZ9T)
...
### <code><wbr />Default<wbr />Organization<wbr />Role<wbr />Not<wbr />Found</code>
...
```json {{ filename: 'Status Code: 400' }}
{
  ...
  "longMessage": "The RelayState parameter is missing from the SAML Response. Note that RelayState is not required if you are using the IdP-initiated flow. See https://clerk.com/docs/authentication/enterprise-connections/authentication-flows#saml",

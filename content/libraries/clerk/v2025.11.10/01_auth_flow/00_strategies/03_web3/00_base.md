...
3. On the sign-in page, you should see **Base** as an option. Use it to sign in.
...
## Connect Base to existing account

Users can connect their Base account to their account at any time through their user profile page. You can configure your application to use the [Account Portal user profile page](https://clerk.com/docs/guides/account-portal/overview.md#user-profile) or the prebuilt [`<UserProfile />`](https://clerk.com/docs/nextjs/reference/components/user/user-profile.md) component.

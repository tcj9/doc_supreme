...
![Flow chart of the account linking process in various scenarios](https://clerk.com/docs/images/authentication/account-linking-flow-oauth.webp)
...
If you disabled the **Verify at sign-up** option in the [Clerk Dashboard](https://dashboard.clerk.com/~/user-authentication/user-and-authentication), users will be able to sign up without verifying their email addresses.
...
2. In the [`<UserProfile />`](https://clerk.com/docs/nextjs/reference/components/user/user-profile.md), add the different email.
